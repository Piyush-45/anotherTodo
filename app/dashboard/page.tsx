...
//? When the form is submitted, it triggers the deleteNote server action. The form data, including the hidden noteId, is automatically passed to this function.